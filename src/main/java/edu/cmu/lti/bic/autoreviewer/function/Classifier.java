...
public class Classifier {
	...
	public final void run(Arguments argu) {
		...
		File workdir = new File(
				"./external_binary/apply_script.app/Contents/MacOS/");
		String[] env = {};
		try {
			String errOutput = "";
	...
	public final ClassifiedData getClassifiedRst(Arguments argu)
		...
		// String start =
		// ServerConfiguration.EEG_TABLE_STRUCTURE[ServerConfiguration.DEFAULT_STARTTIME_INDEX];
		// String end =
		// ServerConfiguration.EEG_TABLE_STRUCTURE[ServerConfiguration.DEFAULT_ENDTIME_INDEX];
		// String subject =
		// ServerConfiguration.EEG_TABLE_STRUCTURE[ServerConfiguration.DEFAULT_SUBJECTID_INDEX];
		// // TODO score is from a different table
		// String score =
		// ServerConfiguration.EEG_TABLE_STRUCTURE[ServerConfiguration.DEFAULT_EEGRAW_INDEX];
		//
